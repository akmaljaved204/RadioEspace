...
public class StreamProxy implements Runnable {
    ...
    public void init() {
        try {
            ...
            // Log.e(LOG_TAG, "Errore inizializzazione server ", e);
        } catch (IOException e) {
            // Log.e(LOG_TAG, "Errore inizializzazione server ", e);
        }
    }
    ...
    public void start() {
        ...
        if (socket == null) {
            throw new IllegalStateException("Impossibile avviare il proxy; Non inizializzato.");
        }
    ...
    public void stop() {
        ...
        if (thread == null) {
            throw new IllegalStateException("Impossibile stoppare il proxy; esso risulta non avviato.");
        }
