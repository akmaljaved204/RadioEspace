...
import egingenierie.radioespace.network.RestClient.RequestMethod;
import egingenierie.radioespace.utils.Constants;

public class APIForRadioData {
    ...
    public APIForRadioData(DataLoader dataLoader, String url, String requestType) {
        this.dataLoader = dataLoader;
        context = (Context) dataLoader;
        new AsyncTaskForNews().execute(requestType, url);
    }
    ...
    public class AsyncTaskForNews extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String sig = Constants.base64Encode(Constants
                        .calculateRFC2104HMACBinary(requestType + time,
